  ...
  return (
    <div className="relative flex justify-center overflow-hidden h-auto bg-light-pink">
      ...
      <div className="absolute inset-0 flex flex-col justify-center ml-[30px] items-start p-4 md:p-8 lg:p-16 z-20">
        ...
        <p className="text-lg md:text-xl lg:text-[44px] mb-8 font-bold md:mb-4" style={{color:"rgba(72, 15, 92, 1)"}}>
         Guiding You to Safe, Natural Births <br/>
        <span className='block mt-[20px]'>with Exceptional Care</span>
          </p>
        <p className="text-base md:text-lg lg:text-[24px] mt-[30px] font-normal" style={{color:"#6B004D"}}>At <span className='font-bold'>Divi,</span> We have the <span  className='font-bold'>highest Normal <br /> Delivery rate in Hyderabad</span> </p>
